    ...
    public class GameScreen : Screen
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            catch (PlayerException pe)
            {
                ...
                FindScreen<GameoverScreen>().setScorePlayer1(gbPlayer1.ScoreManager.Score.ToString());
        ...
        public void ResetBoard(bool gameOver)
        {
            gbPlayer1 = null;
            ...
            if (InputManager.Instance.NbPlayer >= 2)
            {
                FindScreen<GameoverScreen>().setScorePlayer2(gameOver ? gbPlayer2.ScoreManager.Score.ToString() : "");

                gbPlayer2 = null;
                gbPlayer2 = new Gameboard(columns, rows, 750, 700);
                gbPlayer2.Resume();
            }
        }
